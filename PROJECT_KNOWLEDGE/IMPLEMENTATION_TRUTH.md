...
| Jobs/progress/stop/retry | IMPLEMENTED / LIVE VERIFIED | all multi-item downloads use bounded schedulers; Job Details shows live child-video rows; per-job cancellation marks unfinished children, terminates owned processes, stops fallback attempts, and same-ID retry succeeded live with 2/2 media outputs |
