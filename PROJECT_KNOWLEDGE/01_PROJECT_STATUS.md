...
## 2026-09-22 OSS/API milestone

Current source version is `33.2-GUI`. An optional OpenAI Responses API transcript-intelligence provider, provider/privacy tests, public OSS repository files, CI/CodeQL/Dependabot, and security/API documentation were added. Manual ChatGPT exchange remains supported. No v33.2 Windows binary was built during this source-only review.
